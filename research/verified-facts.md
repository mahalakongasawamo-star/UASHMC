...
| Outpatient Department (OPD), Emergency Room, Laboratory, Radiology, Heart & Lung Station | Named as their departments in a holiday advisory. The ER is described as open **"for urgent and emergency cases"** — note this is *not* the same claim as 24/7. | `schedule advisory.jpg` |
| Telemedicine | Content series called **"Doctor in the House"** | social channels |

⚠️ These prices are **transcribed from undated posters**. Safe to *show* as a proposal;
unsafe to *publish* without written confirmation that they are current. Everything in the
...
- **KRISS AI** (`kriss.ai`, originally "Project Kriss") — chatbot-as-a-service built on generative AI.
  Publicly stated pillars: *Seamless Integration*, *Customization*, *Scalability*.
