...
- **Shadow strategy:** Elevation 1 at rest; a *linked* card (the whole card is one link) rises to Elevation 2 on hover with a `brand-500` border. A *static* card has no hover, focus or active state and must not simulate one.
...
- **Do** hold cyan in resting states as well as hover — this is a navy *and* cyan brand, not a navy one with a cyan accent.
