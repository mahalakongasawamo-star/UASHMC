...
UASHMC is a **navy *and* cyan brand, not a navy one.** Measured across their collateral the split
...
| A4 | Text over imagery | Sample the *rendered* pixels behind the text box; worst-case ratio ≥ 4.5:1. Hero currently 7.32 (headline) and 8.13 (lead). |
...
- Prefer stating a limit plainly over hedging around it. *"Only your HMO can confirm what they will
  pay"* is better than an evasion.
